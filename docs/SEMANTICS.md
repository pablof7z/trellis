...
`why_resource_command()`, `why_output_frame()`, `dependency_path()`, and
`scope_resource_inventory()`. Summary explanations identify transactions,
revisions, scopes, changed nodes, collection diffs where present, and
