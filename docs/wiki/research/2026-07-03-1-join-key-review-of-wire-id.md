...
source_lines: 294-322
agent_attribution: joinkey-review
has_preregistered_criteria: true
has_method: true
has_structured_report: true
characterization: "Join-key review of wire_id_hint/canonical_filter_hash: verdict NEEDS FIX — pre-compile shape hash diverges from post-compile wire sub id due to author partitioning and lattice merge, causing silent under-correlation for multi-author feeds"
captured_at: 2026-07-03T10:44:35Z
---

Join-key review of wire_id_hint/canonical_filter_hash: verdict NEEDS FIX — pre-compile shape hash diverges from post-compile wire sub id due to author partitioning and lattice merge, causing silent under-correlation for multi-author feeds
